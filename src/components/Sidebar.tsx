        ...
        <nav className="flex flex-col gap-2 p-4 flex-grow overflow-y-auto">
          ...
          <div className="p-4 border-t border-red-100 border-opacity-30">
            ...
            <button
              ...
              className="flex items-center gap-3 px-4 py-2 rounded-md text-red-600 hover:border-red-500 hover:border cursor-pointer w-full text-left transition text-sm"
            >
              <LogOut size={18} />
              Logout
            </button>
